# Requirements: BiliBiliToolPro v4.0.0.6
...
| Feature | Reason |
|---------|--------|
| Full Web UI redesign | This milestone targets code boundaries, not visual redesign. |
| Replacing MudBlazor or Blazor hosting model | Framework churn would add risk without addressing the boundary problem directly. |
| Repo-wide test strategy rewrite | The milestone only needs targeted Web test coverage for the refactored slices. |
| Notification-boundary extraction as a primary deliverable | Still deferred unless a direct blocker emerges during Web-layer cleanup. |
...
*Last updated: 2026-05-05 after milestone research and scope confirmation*